...
2.  **Header Row:** The first line must be the header: "İşletme Adı","Kategori","Adres","Telefon Numarası","Web Sitesi","E-posta"
3.  **Data Columns:**
...
5.  **Missing Data:** If, after a thorough search with all tools, a piece of information (especially Website or Email) is truly unavailable, use "N/A". Do not use it as a default.
`.trim();
